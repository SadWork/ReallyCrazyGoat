...
def convert_coordinates(x, y, width, height):
    # Преобразование координат изображения от 0 до 1
...
def main():
    ...
    with open('points_red.txt', 'w') as f_red, \
        ...
        # Записываем размеры изображения
        f_red.write(f"{width} {height}\n")
        f_green.write(f"{width} {height}\n")
        f_blue.write(f"{width} {height}\n")
